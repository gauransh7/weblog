			...
			<div class="row">
				...
				<div class="col-lg-8 left-blog-info-w3layouts-agileits text-left">
					<div class="blog-grid-top">
						<div class="b-grid-top">
							...
							<div class="blog-info-middle">
								<ul>
									<li>
										<a href="#">
											<i class="far fa-calendar-alt"></i> <?php echo $created;?></a>
									</li>
									<li class="mx-2">
										<a href="#">
						...
						<h3>
							<a href="single.php"><?php echo $blog_title;?></a>
						</h3>
                                            <p><?php echo $content;?></p>
						<a href="single.php?id=<?php echo $sid?>" class="btn btn-primary read-m">Read Less</a>
					</div>
